<article>
Одним из лучших инструментов для создания уникального дизайна это 
уникальная отзывчивая сетка. Вы можете настроить 
всё, что вам нужно, будь то количество и ширина колонок, отступы 
и даже контрольные точки, в которых вы перестраиваете раскладку страницы.

К сожалению, многие люди даже не пытаются делать свои сетки,
потому что у них не хватает знаний и уверенности в своих силах.

Итак, в этой статье я хочу помочь вам обрести знания и веру в себя, ведь они 
вам понадобятся для создания собственной сетки. Надеюсь, что к концу этой статьи
вы сможете отложить фреймворки и попробовать собственную сетку в следующем
проекте.
...
Прочтите её, если вы хотите научиться проектировать сетки.

**Во-вторых, вам нужно знать, как ваша сетка ведёт себя на экранах разного размера.**

Будете ли вы менять размеры колонок и отступов пропорционально ширине экрана или будете 
менять только ширину колонок, оставляя отступы фиксированными? Будете ли вы менять
...
CSS-сетки вместо HTML-сеток. Еще я написал [статью][4],
...
3.  Как использовать сетку — в стилях или разметке
...
Есть восемь шагов для того, что бы построить вашу сетку. Вкратце, вот эти шаги: 
